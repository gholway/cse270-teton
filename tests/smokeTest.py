...
class TestUntitled():
  ...
  def test_untitled(self):
    self.driver.get("http://localhost:5500/cse270/teton/1.6/")
    self.driver.set_window_size(1726, 1236)
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("apple")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("apple")
    ...
    self.driver.find_element(By.NAME, "biztitle").send_keys("apple")
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("apple")
